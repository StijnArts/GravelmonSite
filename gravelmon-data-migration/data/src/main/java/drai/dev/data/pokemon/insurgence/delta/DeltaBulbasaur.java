...
public class DeltaBulbasaur extends Pokemon {
    ...
    private void setPosingData(boolean isFemale) {
        getPosingFileData(isFemale).setPortraitData( 1.66f, new Vector3(-0.14, -0.74, 0));
        getPosingFileData(isFemale).setProfileData( .98f, new Vector3(0, 0.26, 0));
        getPosingFileData(isFemale).setBasicHead();
        getPosingFileData(isFemale).setRootBone("bulbasaur");
        getPosingFileData(isFemale).setAnimationFileName("deltabulbasaur"+(isFemale ? "_female" :""));
        getPosingFileData(isFemale).addMiscAnimations(
                "cry",
                "recoil"
        );
        getPosingFileData(isFemale).addMiscAnimation("faint", "q.bedrock_primary('deltabulbasaur"+(isFemale ? "_female" :"")+"', 'faint', q.curve('one'))");
